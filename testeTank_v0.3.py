...
class Wall(pygame.sprite.Sprite):
    #This class represents a brick. It derives from the "Sprite" class.
...
while not done:
    ...
    # Creating walls
    # vertical walls
    pygame.draw.line(surface, yellow, [7 * dx_sq1, y_sq1 - (3 * dx_sq1)],[7 * dx_sq1, y_sq1 + (4 * dx_sq1)], dx_sq1)
    pygame.draw.line(surface, yellow, [screen_width - (7 * dx_sq1), y_sq1 - (3 * dx_sq1)],[screen_width - (7 * dx_sq1), y_sq1 + (4 * dx_sq1)], dx_sq1)
    pygame.draw.line(surface, yellow, [(screen_width // 2), lim_tanks_board + (3 * dx_sq1) ],[(screen_width // 2), (screen_height // 2) - (4 * dx_sq1)], 2 * dx_sq1)
    pygame.draw.line(surface, yellow, [(screen_width // 2), (screen_height // 2) + (5 * dx_sq1) ],[(screen_width // 2), screen_height - (4 * dx_sq1)], 2 * dx_sq1)
    # horizontal walls
    pygame.draw.line(surface, yellow, [5 * dx_sq1, y_sq1 - (3 * dx_sq1)],[7.5 * dx_sq1, y_sq1 - (3 * dx_sq1)], 2 * dx_sq1)
    pygame.draw.line(surface, yellow, [5 * dx_sq1, y_sq1 + (4 * dx_sq1)],[7.5 * dx_sq1, y_sq1 + (4 * dx_sq1)], 2 * dx_sq1)
    #pygame.draw.line(surface, yellow, [screen_width - (5 * dx_sq1), y_sq1 - (3 * dx_sq1)],[screen_width - (7.45 * dx_sq1), y_sq1 - (3 * dx_sq1)], 2 * dx_sq1)
    #pygame.draw.line(surface, yellow, [screen_width - (5 * dx_sq1), y_sq1 - (3 * dx_sq1)],[screen_width - (7.45 * dx_sq1), y_sq1 - (3 * dx_sq1)], 2 * dx_sq1)
    pygame.draw.line(surface, yellow, [screen_width - (5 * dx_sq1), y_sq1 - (3 * dx_sq1)],[screen_width - (7.45 * dx_sq1), y_sq1 - (3 * dx_sq1)], 2 * dx_sq1)
    pygame.draw.line(surface, yellow, [screen_width - (5 * dx_sq1), y_sq1 + (4 * dx_sq1)],[screen_width - (7.45 * dx_sq1), y_sq1 + (4 * dx_sq1)], 2 * dx_sq1)
    pygame.draw.line(surface, yellow, [(screen_width // 2) - (10 * dx_sq1),  (screen_height // 2) + 0.5*dx_sq1],[(screen_width // 2) - (6 * dx_sq1), (screen_height // 2) + 0.5*dx_sq1], 2 * dx_sq1)
    pygame.draw.line(surface, yellow, [(screen_width // 2) + (10 * dx_sq1),  (screen_height // 2) + 0.5*dx_sq1],[(screen_width // 2) + (6 * dx_sq1), (screen_height // 2) + 0.5*dx_sq1], 2 * dx_sq1)
